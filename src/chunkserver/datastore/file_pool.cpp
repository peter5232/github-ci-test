...
int FilePoolHelper::PersistEnCodeMetaInfo(
    std::shared_ptr<LocalFileSystem> fsptr, const FilePoolMeta &meta,
...
int FilePoolHelper::DecodeMetaInfoFromMetaFile(
    ...
    uint32_t metaFileSize, FilePoolMeta *meta) {
...
FilePoolState FilePool::GetState() const { return currentState_; }
