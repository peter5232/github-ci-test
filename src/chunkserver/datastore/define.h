...
struct CSChunkInfo {
  ...
  bool operator==(const CSChunkInfo &rhs) const {
    if (chunkId != rhs.chunkId || metaPageSize != rhs.metaPageSize ||
        chunkSize != rhs.chunkSize || blockSize != rhs.blockSize ||
        curSn != rhs.curSn || snapSn != rhs.snapSn ||
        correctedSn != rhs.correctedSn || isClone != rhs.isClone ||
