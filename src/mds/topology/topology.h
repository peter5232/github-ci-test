...
class Topology {
 public:
  ...
  virtual std::vector<PoolsetIdType> GetPoolsetInCluster(
      PoolsetFilter filter = [](const Poolset &) { return true; }) const = 0;
  ...
  virtual std::list<PoolIdType> GetPhysicalPoolInPoolset(
      PoolsetIdType id, PhysicalPoolFilter filter = [](const PhysicalPool &) {
        return true;
      }) const = 0;
...
class TopologyImpl : public Topology {
 public:
  ...
  bool GetPoolset(const std::string &poolsetName, Poolset *out) const override {
  ...
  bool GetPhysicalPool(const std::string &poolName, PoolsetIdType poolsetId,
                       PhysicalPool *out) const override {
  ...
  std::vector<PoolsetIdType> GetPoolsetInCluster(PoolsetFilter filter =
                                                     [](const Poolset &) {
                                                       return true;
                                                     }) const override;

  std::vector<std::string> GetPoolsetNameInCluster(PoolsetFilter filter =
                                                       [](const Poolset &) {
                                                         return true;
                                                       }) const override;
