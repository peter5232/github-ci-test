...
class Poolset {
 public:
  ...
  Poolset(PoolsetIdType id, const std::string &name, const std::string &type,
          const std::string &desc)
      : id_(id), name_(name), type_(type), desc_(desc) {}

  PoolsetIdType GetId() const { return id_; }
 ...
 public:
  PhysicalPool()
      : id_(UNINTIALIZE_ID),
        ...
        desc_(""),
        diskCapacity_(0) {}
  PhysicalPool(PoolIdType id, const std::string &name,
               const PoolsetIdType poolsetId, const std::string &desc)
      : id_(id),
        name_(name),
  ...
  PoolsetIdType GetPoolsetId() const { return poolsetId_; }

  void SetPoolsetId(PoolsetIdType id) { poolsetId_ = id; }
