...
static const char *kHelpStr =
    ...
    "COMMANDS:\n"
    "space : show curve all disk type space, include total space "
    "and used space\n"  // NOLINT
    ...
    "chunkserver-list : show curve chunkserver-list, list all "
    "chunkserver information\n"  // NOLINT
    ...
    "chunk-location : query the location of the chunk corresponding "
    "to the offset\n"  // NOLINT
    "check-consistency : check the consistency of three copies\n"
    "remove-peer : remove the peer from the copyset\n"
    "transfer-leader : transfer the leader of the copyset to the "
    "peer\n"  // NOLINT
    "reset-peer : reset the configuration of copyset, only reset to "
    "one peer is supported\n"  // NOLINT
    ...
    "list-may-broken-vol: list all volumes on majority offline "
    "copysets\n"
    ...
    "You can specify the config path by -confPath to avoid typing "
    "too many options\n";  // NOLINT
